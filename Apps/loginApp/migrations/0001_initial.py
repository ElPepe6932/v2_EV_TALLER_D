# Generated by Django 4.1 on 2022-12-19 02:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('horaInicio', models.CharField(default=7, max_length=20)),
                ('horaTermino', models.CharField(max_length=20)),
                ('numeroEstacionamiento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='loginApp.estacionamiento')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='loginApp.vehiculo')),
            ],
        ),
        migrations.CreateModel(
            name='Boleta',
